...
<template>
    <svg width="18px" height="18px" xmlns="http://www.w3.org/2000/svg" aria-label="Samsung" role="img" viewBox="0 0 512 512" fill="#F8EDEB">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
            <rect width="512" height="512" rx="15%" fill="#F8EDEB"></rect>
            <path
