...
<template>
    <svg height="24px" width="24px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
        ...
        <g id="SVGRepo_iconCarrier">
            <g>
                <path style="fill:#8DC3E9;"
                    d="M255.996,159.418c-36.473,0-66.145-29.673-66.145-66.145s29.673-66.145,66.145-66.145 s66.145,29.673,66.145,66.145S292.469,159.418,255.996,159.418z">
                </path>
                <path style="fill:#8DC3E9;"
                    d="M362.667,318.735H149.326c-8.818,0-15.967-7.149-15.967-15.967 c0-67.623,55.015-122.637,122.637-122.637s122.637,55.014,122.637,122.637C378.634,311.587,371.485,318.735,362.667,318.735z">
                </path>
            </g>
            <g>
