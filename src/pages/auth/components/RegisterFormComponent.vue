        ...
        <div
            ...
            <a-form @finish="registerAccaount" :model="registerForm" layout="vertical" class="w-full">
                <a-row class="!mt-6" :gutter="[16, 16]">
                    <a-col :xs="24" :sm="24" :md="12">
                        <a-form-item name="name" label="Ismingiz"
                            ...
                            <a-input allow-clear v-model:value="registerForm.name" autocomplete="off"
                    ...
                    <a-col :xs="24" :sm="24" :md="12">
                        <a-form-item name="surname" label="Familyangiz"
                            :rules="[{ required: true, message: 'Majburiy Maydon!' }]" class="flex-1">
                            <a-input allow-clear v-model:value="registerForm.surname" autocomplete="off"
                ...
                <a-row class="!mt-6" :gutter="[16, 16]">
                    <a-col :xs="24" :sm="24" :md="12">
                        <a-form-item name="userName" label="Foydalanuvchi nomi"
                            :rules="[{ required: true, message: 'Majburiy maydon!' }]" class="flex-1">
                            <a-input allow-clear v-model:value="registerForm.userName" autocomplete="off"
                ...
                <div class="flex justify-between items-center !mt-[40px] w-full">
                    <p class="text-white m-0 inline-block">
