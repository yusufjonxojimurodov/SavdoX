    ...
    <div v-if="images.length" class="flex flex-col-reverse sm:!flex-row gap-6 items-start">
        <div class="flex items-center justify-center !mb-5 w-full sm:flex-col sm:w-[20%] gap-3">
            <div v-for="(img, index) in images" :key="index"
                class="w-20 h-20 cursor-pointer overflow-hidden rounded-lg border-2 transition-all duration-300"
        ...
        <div class="relative w-[99%] h-[400px] sm:!w-[400px] overflow-hidden rounded-2xl shadow-lg">
